const ROLE = 'reviewer';  // 보드마다 'leader'/'reviewer'/'ceo'/'manager'로 바꿔 주세요
 ...
 function doPost(e) {
    try {
      ...
      console.log('웹훅 호출됨:', { sheetId, rowNumber, userName, column, value });
      ...
      return ContentService
        .createTextOutput(JSON.stringify({ success: true, message: '트리거 실행 완료' }))      
