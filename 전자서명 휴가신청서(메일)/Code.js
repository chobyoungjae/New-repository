...
const CONFIG = {
  ...
  WEBAPP_URL:
    'https://script.google.com/macros/s/AKfycby4iGuULONTYVobchGkiBfG5hAfoTGpDij5pdXC3V3gF8xhKZNUxEDweBxgrz4w3wOcZg/exec', // ← 고정 URL
...
function onFormSubmit(e) {
  ...
  sheet
    .getRange(row, CONFIG.COL_LEADER)
...
function doGet(e) {
  ...
  if (role === 'leader') {
    ...
    try {
      ...
      // 검토자 이름 수식 (N열)
      sheet
        .getRange(r, CONFIG.COL_REVIEWER)
  ...
  if (role === 'reviewer') {
    ...
    // P열 수식 삽입 → 상수 사용
    sheet
      .getRange(r, CONFIG.COL_CEO) // 16 = P열
